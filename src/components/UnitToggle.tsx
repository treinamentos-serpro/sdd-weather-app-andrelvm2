  ...
  return (
    ...
    >
      <button
        ...
        className="min-h-11 min-w-12 px-3 py-2 font-semibold text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-accent-400 focus:ring-offset-2 focus:ring-offset-night-900 aria-pressed:bg-accent-500 aria-pressed:text-white aria-pressed:hover:bg-accent-400"
